            ...
            items: [
                    {
                        ...
                        items: [
                                {   // column 1
                                    ...
                                    items: [
                                            { id: me.prefix + 'matName', name: 'matName', fieldLabel: 'Material Name',labelStyle: 'text-align: right', emptyText: '[Material Name]', anchor: '-600'}
                                    ]
                                }
...
MeterialForm.prototype.popUpEditItem = function (dataview, record, parent, mode) {
    ...
    MeterialForm.prototype.popUpEditMaterial(id, unitId, matName, matDetail,matPrice, matReorderPoint);
};
...
//handle change role
MeterialForm.prototype.popUpEditMaterial = function (id, unitId, matName, matDetail,matPrice, matReorderPoint) {
