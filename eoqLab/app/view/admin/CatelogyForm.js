Ext.define('CatelogyForm', {
     extend: 'Ext.Panel',

    constructor: function (config) {
        var me = this;
        var prefix = "CatelogyForm-";
        me.prefix = prefix;
        ...
        Ext.apply(this, {
            ...
            items: [
                    {
                        ...
                        , buttons: [ //buttons
                                    ...
                                    handler: function (btn, evt) {
                                        ...
                                        me.search(window.gridCatelogyData, me.name);
                                    } // end handler
                                }, {
                                    iconCls: 'icon-reload',
                    ...
                    handler: function (btn, evt) {
                        ...
                        if (recordsSelected.length) {
                            Ext.MessageBox.confirm('Confirm', 'Are you sure you want to delete that?', function (cbtn, bool) {
                                if (cbtn == 'yes')    //                            
                                    me.deleteCatelogy(gridpanel, recordsSelected, 'Delete');   //    
                            });
                        }
                    }
                },
            ...
            //create new poppu
            var quickConfWindow = new EditCatelogyWindow(
            {
                listeners: {
        ...
        //me.gridStore.setpro
        CatelogyForm.superclass.constructor.apply(this, arguments);
    } // end constructor
});

//fn update
CatelogyForm.prototype.popUpEditItem = function (dataview, record, parent, mode) {
    var id = record.get('Id');
    var name = record.get("Name");
    CatelogyForm.prototype.popUpEditCatelogy(id, name);
};

//fn search
CatelogyForm.prototype.search = function (url, name) {
    var prefix = 'CatelogyForm-';
...
CatelogyForm.prototype.popUpEditCatelogy = function (id, name) {
    var prefix = 'updateCatelogy-';
    var url = window.updateCatelogy;
...
//delete Catelogy
CatelogyForm.prototype.deleteCatelogy = function (dataview, reconds, type) {
    var CatelogyIds = [];
    ...
    var method = window.deleteCatelogy;
    ...
    $.ajax({
        ...
        success: function (result) {
            Ext.MessageBox.hide();
            var me = this
            me.url = window.gridCatelogyData
            if (result.success) {
                Ext.MessageBox.alert('Status', result.message);
                CatelogyForm.prototype.search(me.url,"");
            }
            else {
