Ext.define('EditBrandWindow', {
    ...
    initComponent: function () {
        ...
        EditBrandWindow.superclass.initComponent.apply(me, arguments);
    } // end initComponent
});// end Ext.define('EditBrandWindow


EditBrandWindow.prototype.create = function () {
...
EditBrandWindow.prototype.isValid = function () {
    console.log('isValid');
    var prefix = this.prefix;
...
EditBrandWindow.prototype.editUserAndRoles = function (id, username, email, role, parent) {
...
EditBrandWindow.prototype.prepareData = function () {
