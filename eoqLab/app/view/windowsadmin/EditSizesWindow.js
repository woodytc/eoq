Ext.define('EditSizesWindow', {
    ...
    initComponent: function () {
        ...
        EditSizesWindow.superclass.initComponent.apply(me, arguments);
    } // end initComponent
}); // end Ext.define('EditSizesWindow


EditSizesWindow.prototype.create = function () {
...
EditSizesWindow.prototype.isValid = function () {
    console.log('isValid');
    var prefix = this.prefix;
...
EditSizesWindow.prototype.editUserAndRoles = function (id, username, email, role, parent) {
...
EditSizesWindow.prototype.prepareData = function () {
