Ext.define('EditCatelogyWindow', {
    ...
    initComponent: function () {
        ...
        var CatelogyManage = {
            ...
            items: [
                { id: me.prefix + 'Name', name: 'Name', fieldLabel: 'หมวดสินค้า', afterLabelTextTpl: required, labelStyle: 'text-align: right'
                    , xtype: 'textfield', fieldStyle: 'text-align: right', allowBlank: false,  emptyText: '[หมวดสินค้า]'
                }
            ]
        };
                    ...
                    if (true) {
                        ...
                        form.submit({
                            ...
                            success: function (formPanel, action) {
                                ...
                                Ext.MessageBox.alert('Status insert comple !!');
        ...
        EditCatelogyWindow.superclass.initComponent.apply(me, arguments);
    } // end initComponent
});// end Ext.define('EditCatelogyWindow


EditCatelogyWindow.prototype.create = function () {
...
EditCatelogyWindow.prototype.isValid = function () {
    console.log('isValid');
    var prefix = this.prefix;
...
EditCatelogyWindow.prototype.editUserAndRoles = function (id, username, email, role, parent) {
...
EditCatelogyWindow.prototype.prepareData = function () {
