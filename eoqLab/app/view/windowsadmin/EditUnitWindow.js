Ext.define('EditUnitWindow', {
    ...
    initComponent: function () {
        ...
        EditUnitWindow.superclass.initComponent.apply(me, arguments);
    } // end initComponent
});                                                                        // end Ext.define('EditUnitWindow


EditUnitWindow.prototype.create = function () {
...
EditUnitWindow.prototype.isValid = function () {
    console.log('isValid');
    var prefix = this.prefix;
...
EditUnitWindow.prototype.editUserAndRoles = function (id, username, email, role, parent) {
...
EditUnitWindow.prototype.prepareData = function () {
