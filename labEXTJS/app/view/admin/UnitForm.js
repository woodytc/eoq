...
UnitForm.prototype.popUpEditItem = function (dataview, record, parent, mode) {
    ...
    UnitForm.prototype.popUpEditUserAndRoles(id, id, email, role === 'User Managemant' ? "UserManage" : role, parent);
};

//fn reset password
UnitForm.prototype.popUpResetPassword = function (dataview, record, parent, mode) {
    var id = record.get('UserName');
    var email = record.get('Email');
    var role = record.get('Roles');
    UnitForm.prototype.resetPassword(id, id, email, role, parent);
};

//fn Disable user
UnitForm.prototype.popUpDisableUser = function (dataview, record, parent, mode) {
    var id = record.get('UserName');
    var email = record.get('Email');
    var role = record.get('Roles');
    var status = record.get('IsApproved');

    UnitForm.prototype.disableUser(id, id, email, role, status, parent);
};

//fn search
UnitForm.prototype.search = function (url, username, role) {
    var prefix = 'UnitForm-';
...
//handle change role
UnitForm.prototype.popUpEditUserAndRoles = function (id, username, email, role, parent, mode) {
    var prefix = 'roleform-';
                ...
                */
                ...
                Ext.Ajax.request({
                    ...
                    success: function (response) {
                        ...
                        UnitForm.prototype.search(window.gridData, "", "All Role");
